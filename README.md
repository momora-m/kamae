...
| パネル | 内容 |
| --- | --- |
| Viewport | 立方体と床。左ドラッグでカメラが周回。マウスがあるとき WASD で歩く。床の端で止まる |
| Cube | 位置と回転（度） |
